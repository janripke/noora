...
from noora.exceptions.plugins.blocked_host_exception import BlockedHostException
from noora.exceptions.plugins.unknown_version_exception import UnknownVersionException
...
class Fail(object):
    ...
    def fail_on_invalid_host(host, properties):
        ...
        :param properties: Properties containing the host list
        """
