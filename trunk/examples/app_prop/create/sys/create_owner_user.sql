...
define TS_NOLOGGING = TS_NOLOGGING
...
-- niet standaard, kan afwijken per project. (kpnquad)
grant create public synonym to &SCHEMA_OWNER;
...
alter user &SCHEMA_OWNER quota unlimited on &TS_DEFAULT;
alter user &SCHEMA_OWNER quota unlimited on &TS_INDEX;
alter user &SCHEMA_OWNER quota unlimited on &TS_NOLOGGING;
