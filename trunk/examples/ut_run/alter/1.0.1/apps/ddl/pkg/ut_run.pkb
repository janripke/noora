create or replace package body ut_run as
  ...
  function find_methods(p_package_name varchar2) return t_argument_list is
    ...
    cursor c_all_arguments(b_package_name in varchar2) is
      ...
      where  a.object_name = upper(b_package_name)
      and    upper(substr(a.procedure_name,1,2)) = 'T_';
  ...
  begin
    ...
    loop
      ...
      argument_list(argument_list.last).method_name := r_all_arguments.procedure_name;
    end loop;
