...
TARGET_DIR=CREATE_DIR+os.sep+'target'
...
if __name__ == "__main__":
  ...
  for schema in SCHEMAS:
    ...
    for object in SCHEMA_OBJECTS:
      ...
      #stream=utils.read_file(TARGET_DIR+os.sep+schema+'_'+'ddl'+'_'+object+'_'+environment+'.lst')
      ...
      url=TARGET_DIR+os.sep+schema+'_'+'ddl'+'_'+object+'_'+environment+'.lst'
      if os.path.isfile(url):
        print TARGET_DIR+os.sep+schema+'_'+'ddl'+'_'+object+'_'+environment+'.lst'
      
      # global ddl objects
      #folder=CREATE_DIR+os.sep+schema+os.sep+'ddl'+os.sep+object
      #execute_objects(folder,oracle_sid,oracle_user,oracle_passwd,schema_users)
      print TARGET_DIR+os.sep+schema+'_'+'ddl'+'_'+object+'.lst'

    # environment specific dat objects
    #folder=CREATE_DIR+os.sep+schema+os.sep+'dat'+os.sep+environment
    #execute_objects(folder,oracle_sid,oracle_user,oracle_passwd,schema_users)
    print TARGET_DIR+os.sep+schema+'_'+'dat'+'_'+environment+'.lst'

    # global dat objects
    #folder=CREATE_DIR+os.sep+schema+os.sep+'dat'
    #execute_objects(folder,oracle_sid,oracle_user,oracle_passwd,schema_users)
    print TARGET_DIR+os.sep+schema+'_'+'dat'+'.lst'
