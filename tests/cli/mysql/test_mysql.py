...
from noora.plugins.mysql.drop import cli as drop
from noora.plugins.mysql.create import cli as create
from noora.plugins.mysql.update import cli as update
from noora.plugins.mysql.recreate import cli as recreate
# from noora.plugins.mysql.deploy import cli as deploy
...
def test_drop_connection_string_pass(command: MagicMock):
    ...
    runner = CliRunner()
    result = runner.invoke(drop, obj=props, args=["--connection-string", "host=localhost,port=3306,database=acme,username=acme_owner,password=acme_owner"])
...
def test_drop_host_mismatch_fail(command: MagicMock):
    ...
    runner = CliRunner()
    result = runner.invoke(drop, obj=props, args=["--connection-string", "host=unknown_host,port=3306,database=acme,username=acme_owner,password=acme_owner"])
...
def test_create_host_mismatch_fail(command: MagicMock):
    ...
    runner = CliRunner()
    result = runner.invoke(create, obj=props, args=["--connection-string", "host=unknown_host,port=3306,database=acme,username=acme_owner,password=acme_owner"])
...
def test_update_host_mismatch_fail(command: MagicMock):
    ...
    runner = CliRunner()
    result = runner.invoke(update, obj=props, args=["--version", "1.0.1", "--connection-string", "host=unknown_host,port=3306,database=acme,username=acme_owner,password=acme_owner"])
...
def test_recreate_connection_string_pass(command: MagicMock):
    ...
    runner = CliRunner()
    result = runner.invoke(recreate, obj=props, args=["--host", "localhost", "--connection-string", "host=localhost,port=3306,database=acme,username=acme_owner,password=acme_owner"])
...
def test_recreate_host_mismatch_fail(command: MagicMock):
    ...
    runner = CliRunner()
    result = runner.invoke(recreate, obj=props, args=["--connection-string", "host=unknown_host,port=3306,database=acme,username=acme_owner,password=acme_owner"])
