...
class MainToolBar(wx.ToolBar):
  ...
  def __init__(self,parent,id,*args, **kwargs):        
    ...
    self.AddLabelTool(Settings.ID_NEW_PROJECT, '', wx.ArtProvider.GetBitmap(wx.ART_NEW, wx.ART_TOOLBAR, (16, 16)),wx.NullBitmap,0,'Create a new project','Create a new project')
    self.AddLabelTool(Settings.ID_OPEN_PROJECT, '', wx.ArtProvider.GetBitmap(wx.ART_FILE_OPEN, wx.ART_TOOLBAR, (16, 16)),wx.NullBitmap,0,'Open an existing project','Open an existing project')
