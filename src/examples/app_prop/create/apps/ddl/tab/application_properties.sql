...
)tablespace KPNLC_DATA;


alter table APPLICATION_PROPERTIES add constraint APP_PROP_ID_PK primary key (ID) using index tablespace KPNLC_INDEX;
...
alter table APPLICATION_PROPERTIES add constraint APP_PROP_NAME_UNIQ unique (NAME) using index tablespace KPNLC_INDEX;
